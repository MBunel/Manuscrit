...
\onto{A\-Dist\-ance\-Temps}, plus précis et adapté.
...
\onto[orl]{Prox\-imal}, que nous avons décrite comme appartenant à la
...
\emph{classe abstraite}
\onto[orl]{Re\-la\-tion\-Spa\-ti\-ale\-De\-Prox\-imi\-te}. De fait,
...
Les concepts définis dans \ac{orl} étant fortement inspirés, voire
...
leurs dérivées composées (\eg \onto[orl]{Au\-Sud\-De\-Ex\-ter\-ne}),
