...
d'interrogation des données.  Toutefois, même en considérant toutes
les données à la disposition des secouristes, quel que soit leur
format, il reste des descriptions qu'il est impossible d'interpréter…
faute de données. Ce peut être le cas lorsqu'il se réfère à un objet
