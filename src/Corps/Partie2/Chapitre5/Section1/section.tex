...
\subsection{Le corpus des alertes}
...
produits par les \ac{pghm} de Chamonix (5 alertes) et de Grenoble (47
alertes) à l'aide d'un enregistreur numérique. Cependant, les
discussions dont nous disposons sont tronquées, d'une part car
l'enregistrement est réalisé au niveau de la ligne téléphonique des
\ac{pghm} et non des \ac{codis}, généralement contactés par les
requérants (cf. \autoref{chap:02}), les appels ne sont enregistrés que
lorsque un secouriste du \ac{pghm} intègre la discussion, de plus les
