...
valeur \(v\) nulle et un paramètre
\(\delta\) de \SI{500}{\meter} (Figure
\ref{fig:fuzzy_veyont_angleNord_2}. Les Figures
...
La relation de localisation \onto[orl]{Entre\-X\-et\-Y} est, quant a
