...
\begin{dialogue*}
  ...
  là, au milieu de nulle part… \direct{Inaudible}
  % 
  ...
  % 
  \Req \direct{Parle en même temps} Voilà… Oui…
  % 
  \Sec OK…
  % 
  ...
  % 
  \Sec \direct{Parle en même temps} Et vous avez jamais recroisé un
  chemin ?
  % 
  ...
  dans la plaine ?
  % 
  \Req Eh ben je vois un peu d'eau… Je vois… \direct{Inaudible}
  % 
