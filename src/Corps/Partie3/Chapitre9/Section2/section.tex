...
(\auotref{chap:05}), cette première étape est triviale, les indices de
...
Le premier des indices de localisation que nous avons identifié est :
\enquote{le requérant est \onto[orl]{Hors\-De\-Planimetrique} du
  sommet du \emph{Grand Veymont}}

Comme nous l'expliquions dans le \autoref{chap:07}, la relation de
