\begin{tikzpicture}
  ...
  % Arrow
  \begin{scope}
    \path[ffc, -, shorten >=12pt, shorten <=5pt] (1,2) |- (3.65,3);
    \path[ffc, ->,shorten >=5pt, shorten <=5pt] (8.25,3) -- (10,3);
    \path[ffc2, -,shorten >=12pt, shorten <=5pt] (1,0) |- (3.65,-1);
    \path[ffc2, ->,shorten >=5pt, shorten <=5pt] (8.25,-1) -- (10,-1);
  \end{scope}
