...
localisaiton : \enquote{La victime est sous une ligne électrique trois
  brins} (\ref{ind:fr6}). On peut remarquer la zone de localisation
probable obtenue est plus étendue que précédemment, de nouveaux
clusters de positions non nulles apparaissant, et que le degré
d'appartenance des positions qui y appartenaient déjà est généralement
supérieur à la précédente version de la \ac{zlp}.
