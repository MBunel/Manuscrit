...
question de la spatialisation des descriptions de positions. Pour y
répondre, nous avons proposé une méthode que nous avons voulu
générique, tout en la calibrant spécifiquement pour notre cas
d’application, le secours en montagne.
...
en des zones de localisation et la fusion les regroupe, jusqu'à
...
\autocite{Zadelg1965}. Ainsi, la phase de spatialisation crée des
zones de localisation floues, c'est-à-dire dotées de limites
