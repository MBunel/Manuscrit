...
visualisation des données géographiques utilisables pour la
localisation de la victime, c'est-à-dire issues des bases de données
enrichies et produites par les méthodes permettant d'identifier les
zones correspondant aux descriptions de position. Ce troisième
objectif porte également sur la conception d'une interface d'aide à la
décision. Cette interface est centrale dans le projet, puisqu'elle
constitue le seul point d'entrée, pour les secouristes, à l'ensemble
des travaux proposé dans le projet.

Comme nous l'avons précédemment mentionné cette interface doit
permè

Également confrontée à la question de l'imprécision du
langage naturel, le développement de cette interface nécessite un
