...
La localisation des victimes peut être améliorée ou facilitée par
l'utilisation de solutions de permettant une géolocalisation facile,
précise et non ambiguë, comme les récepteurs GPS. La généralisation
des smartphones, qui en sont majoritairement équipés, a fait émerger
un marché de solutions de partage de localisation pensées pour le
secours. Les applications dédiées, comme \emph{Alpify,} sont peu à peu
supplantées par les solutions directement intégrées dans le système
d'exploitation des appareils, comme le système \emph{Android Emergency
  Location Service} \autocite{Google2019}. De telles solutions sont
certes utiles, mais elles ne sont que des aides occasionnelles,
totalement dépendantes de la victime et de sa capacité a les
utiliser. Il existe cependant deux solutions que les secouristes
peuvent utiliser a leur initiative, l'identification de l'antenne GSM
servant à passer l'appel et l'application de géolocalisation
\emph{Gend'Loc.}
...
l'antenne téléphonique de rattachement, le requérant peut donc se
situer n'importe où dans la zone couverte par l'antenne. Or, lorsque
que le maillage est composé d'un faible nombre d'antennes puissantes,
comme c'est généralement le cas en dehors des milieux urbains, la zone
couverte par l'antenne peut devenir très importante (\ie atteindre
plusieurs centaines de km\up{2}) et donc ne pas permettre une
localisation suffisamment précise. À cela s'ajoute le fait que la zone
couverte par une antenne peut varier sensiblement, notamment en
fonction des conditions météo, ce qui renforce l'imprécision de la
localisation par ce bais \autocite{FenChong2012,OlteanuRaimond2012}.
...
Dans les faits, cette solution n'est que rarement employée par les
secouristes, généralement lors qu’aucune des informations données par
le requérant ne sont suffisantes pour le localiser, que la phase de
localisation dure et que l’application \emph{Gend'Loc} n'est pas
utilisable.
...
auprès des opérateurs téléphoniques et ce sans nécessiter un aval
judiciaire.

% Mouvement vers l'informatisation Google IRega
...
\begin{figure}
  \centering
  \input{../figures/BourgDOisans.tex}
