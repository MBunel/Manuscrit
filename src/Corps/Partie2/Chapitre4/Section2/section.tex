...
permis par cette approche compensent la multiplication des
...
est possible de les \emph{spatialiser.}
...
décompose en trois étapes, répondant aux trois étapes de la
\emph{phase de décomposition.}
