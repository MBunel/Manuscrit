...
qu'il soit égal à 1, ce qui correspond à \emph{l'ensemble de
  référence} \(X\) (\autoref{fig:tiers-exclu}) ou nul, ce qui équivaut
à l'enseble vide (\autoref{fig:non-contradiction}). À l'inverse, les
opérateurs de \bsc{Zadeh} ou probabilistes aboutissent à une zone non
uniforme, contenant des positions dont le degré d'appartenance est
inférieur à 1 (\autoref{fig:tiers-exclu}) ou supérieur à zéro
