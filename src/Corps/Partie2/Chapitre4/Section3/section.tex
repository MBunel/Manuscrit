...
une \ac{zlc} est construite indépendamment pour chacun d'entre-eux. Au
début de la phase de fusion, on dispose donc de onze \ac{zlc} (comme
le montre la partie supérieure de la \autoref{fig:ex_fus_rsa}) qu'il
va falloir fusionner de sorte à obtenir une \ac{zlp}.
