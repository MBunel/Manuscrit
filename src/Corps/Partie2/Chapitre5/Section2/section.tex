...
l'ontologie on trouve trois classes abstraites principales, regroupant
l'ensemble des \emph{relations de localisation} et deux
\emph{relations de localisation} isolées et complémentaires,
\onto[orl]{XVoitY} et \onto[orl]{XEstVuParY}.
