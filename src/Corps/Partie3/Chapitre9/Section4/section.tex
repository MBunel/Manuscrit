...
pour chaque alerte (\autoref{chap:01}). Toutefois l'exploitation fine
...
relation \onto{Connecte\-A\-Antenne} nécessiterai, en effet, de
prendre la portée du signal, fortement influencée par les conditions
