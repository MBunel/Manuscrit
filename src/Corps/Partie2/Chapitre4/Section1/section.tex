...
des connaissances, librement inspirée des \emph{systèmes à base de
  ...
  \url{https://hal.inria.fr/inria-00201566/document}}. Dans les
\emph{systèmes à base de connaissances,} les connaissances sont
formalisées au sein d'une ontologie lue et interprétée par un
logiciel. Ainsi, on peut imaginer que les règles de
