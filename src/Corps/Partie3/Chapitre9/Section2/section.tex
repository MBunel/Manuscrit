...
\autoref{chap:07}. L'utilisation du fuzzyficateur \onto[orla]{Sup\-Val\-0}
...
un point, il s'agit d'une zone sommitale pour le sommet du \emph{Grand
  Veymont} et d'un point de passage relativement étendu pour le \emph{Pas de
la Ville.} Si il peut être satisfaisant de représenter un sommet par
un point, cette approximation est un peu plus d

Or, la représentation d'un objet géographique étendu, comme
un pas ou une crête, par un point est une approximation conséquente,
impactant fortement la spatialisation.
