...
préfets de département. Ces derniers sont également désignés comme les
seuls \emph{directeurs des opérations de secours} en montagne
\acp{dos}. Ce statut ne leur impose pas au de participer
\emph{directement} aux opérations de secours. Leur conduite incombe au
\emph{commandant des opérations de secours} \acp{cos}, dont le
processus de désignation change en fonction de \emph{la nature de
  l'opération.}
