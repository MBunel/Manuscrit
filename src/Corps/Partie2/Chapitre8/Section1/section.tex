...
par exemple la logique ternaire de \bsc{Łukasiewicz} valide ces deux
principes.
...
\bsc{Zadeh} sont idempotents, les applications successives des
...
pour les opérateurs de \bsc{Łukasiewicz}, probabilistes et drastiques
...
de deux \emph{relations de localisation} ; \onto[orl]{A\-L\-Est\-De}
et \onto[orl]{Au\-Sud\-de}, pour le même \emph{objet de référence.}
...
\emph{t-conorme} archimédienne, revient a considérer que l'assertion
...
\emph{t-conorme} non-idempotente. En effet rien dans une formulation
employant un \emph{objet de référence indéfini} n'impliquant que la
...
différentes \ac{zlc}, plus son degré d'appartenance à la \ac{zlp} sera
faible. La non-idempotence conduit donc à utiliser des opérateurs
