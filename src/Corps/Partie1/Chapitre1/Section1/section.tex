...
l’application \emph{Gend'Loc.} Contrairement à une application pour
...
peuvent connaître rapidement et précisément la position de la victime,
...
effet, \emph{Gend'Loc} permet de générer un plan centré sur la
position de la victime et de le lui transmettre. Cela permet
généralement à la victime de retrouver son chemin
\autocite{Muscat2015}.
...
\subsubsection{Le cas du \enquote{\emph{fil rouge}}}
