...
de \bsc{Zadeh} sont parfaitement adaptés à la réalisation
d'intersection et d'unions inter-sous-ensembles flous et donc à la
\emph{phase de fusion,} mais les opérateurs alternatifs (\ie les
opérateurs de \bsc{Łukasiewicz}, probabilistes et drastiques),
permettent de modifier le résultat des étapes de fusion, en proposant
des intersections et des unions plus ou moins sévères
(\autoref{chap:03}). L'utilisation d'opérateurs alternatifs pose
