...
emploie la relation de localisation
\onto[orl]{Dans\-La\-Direction\-De\-X\-Depuis\-Y} et un objet
...
\begin{figure}
  ...
  \subfloat[]{
    \begin{tikzpicture}[remember picture]
      \node[anchor=south west] (img) {\includegraphics[width=\linewidth]{../figures/ZLP_FilRouge/ZLP.png}};
  ...
  \subfloat[]{%
    \begin{tikzpicture}[remember picture]
      \node (img1) {\includegraphics{../figures/ZLP_FilRouge/ZLP_2.png}};
      \draw (img1.south west) rectangle (img1.north east);
    \end{tikzpicture}
  }\hfill
  \subfloat[]{%
    \begin{tikzpicture}[remember picture]
      \node (img2) {\includegraphics{../figures/ZLP_FilRouge/ZLP_3.png}};
      \draw (img2.south west) rectangle (img2.north east);
    \end{tikzpicture}
  }\hfill
  \subfloat[]{%
    \begin{tikzpicture}[remember picture]
      \node (img3) {\includegraphics{../figures/ZLP_FilRouge/ZLP_4.png}};
