...
\begin{figure}
  ...
  \caption{Métrique \protect\onto[orla]{Delta\-Nearest\-Val} calculée à partir
...
\begin{figure}
  ...
  \caption{Zone de localisation compatible pour le second indice de
    localisation de l'alerte \emph{Grand Veymont :} \enquote{Le
      ...
      \emph{Grand Veymont,} avec une certitude normale} \ref{ind:gv2}}
...
\begin{figure}
  ...
  \caption{Zone de localisation compatible pour le second indice de
    localisation de l'alerte \emph{Grand Veymont :} \enquote{Le
      requérant est \protect\onto[orl]{Au\-Nord\-De} du \emph{Pas de
        la Ville,} avec une certitude normale} \ref{ind:gv3}}
...
\begin{figure}
  ...
  \caption{\ac{zlc} de la relation de localisaiton
    \protect\onto[orl]{Hors\-De\-Planimétrique} pour le \emph{Pas de la Ville}}
\end{figure}
