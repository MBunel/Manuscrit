\begin{tikzpicture}
  ...
  %%% Lvl 1
  \matrix [matrix of math nodes, anchor=west,
  ...
  ([yshift=2cm]I.north east)
  {i_1&i_2&\cdots{}&i_n\\};

  \matrix [matrix of nodes, anchor=west, nodes={minimum size=1cm}]
  (zlc) at ([xshift=5cm]is.east) {
  ...
  ([yshift=2cm]is-1-1.north east) {o_1&o_2&\cdots{}&o_n\\};

    \matrix [matrix of nodes,
  anchor=west,
  nodes={minimum size=1cm}
  ] (zlb) at
  ([xshift=5cm]is_o.east)
  {
    \draw[ffa,ffc] (0,0) circle (.3cm);&
    \draw[ffa,ffc] (0,0) circle (.3cm);&
    \node{$\cdots{}$};&
  ...
  ([yshift=2cm]is_o-1-1.north east)
  {
    \text{\textsf{rsa}}_1&
    \text{\textsf{rsa}}_2&
    \cdots{}&
