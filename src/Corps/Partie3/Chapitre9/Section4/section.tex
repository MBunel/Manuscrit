...
d'un temps de marche donné. Nous avons choisi de fixer la valeur de
\(v\) à 6 heures, ce qui indique que toute position atteignable en
moins de 6 heures de marche à partir de \emph{Bourg-d'Oisans}
appartiendra totalement à la \ac{zlc} de ce premier sous-indice
(\autoref{fig:select_infval}).
