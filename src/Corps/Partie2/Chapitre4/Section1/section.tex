...
notions. Aussi, ces deux \enquote{sous} ont plus de points communs,
que de points de divergence. Ces points communs dans la signification
constituent ce que nous appelons des \emph{récurrences sémantiques.}
Une manière d'améliorer notre précédent postulat pourrait être d'y
intégrer cette notion et donc de ne pas distinguer des variantes de
\emph{relations de localisation,} mais leur \emph{composantes
  sémantiques} et exploiter cette nouvelle information
\autocite{Bunel2019a}.
