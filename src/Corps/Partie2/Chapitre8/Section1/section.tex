...
\bsc{Zadeh}, de \bsc{Łukasiewicz}, probabilistes et drastiques
...
étaient les opérateurs de \bsc{Zadeh} \footnote{Voir les équations
...
\autocite{Zadeh1965}. Les opérateurs de \bsc{Zadeh} sont tout à fait
...
opérateurs alternatifs (\ie les opérateurs de \bsc{Łukasiewicz},
