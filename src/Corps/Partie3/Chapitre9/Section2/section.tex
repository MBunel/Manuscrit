...
\begin{table}
  ...
  \begin{tabular}{cccc}
    ...
    \multirow{2}{*}{\ref{ind:gv4}} & \onto[orla]{Sup\-Val\-0} & \emph{0} & \SI{100}{\meter}\\
           & \onto[orla]{Sup\-Val\-0} & \emph{0} & \SI{100}{\meter}\\
    \multirow{2}{*}{\ref{ind:gv5}} & \onto[orla]{Inf\-Val\-0} & \emph{0} &
                                                                           \SI{10}{\meter}\\
           & \onto[orla]{Inf\-Val\-0} & \emph{0} & \SI{10}{\meter}\\
    \ref{ind:gv6} & \onto[orla]{Inf\-Val\-0} & \emph{0} &
                                                          \SI{10}{\meter}\\
    \ref{ind:gv7} & \onto[orla]{Inf\-Val\-0} & \emph{0} &
                                                          \SI{10}{\meter}\\
    \ref{ind:gv8} & \onto[orla]{Inf\-Val\-0} & \emph{0} &
                                                          \SI{10}{\meter}\\
    \ref{ind:gv9} & \onto[orla]{Inf\-Val\-0} & \emph{0} & \SI{10}{\meter}\\
    \bottomrule
  \end{tabular}
