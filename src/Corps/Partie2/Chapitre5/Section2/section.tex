...
\tdi{3 classes principales + visibilité} Ai premier niveau de
l'ontologie on trouve trois classes principales,
...
principales son similaires au trois classes du premier niveau
...
regroupe les \emph{relations de localisation}

La classe \onto[orl]{Re\-la\-tion\-Spa\-ti\-ale\-Fonc\-tio\-nelle},
pendant de la classe
\onto[gum]{Func\-ti\-on\-al\-Spa\-ti\-al\-Mo\-da\-li\-ty}, regroupe
les \emph{relations}
%
Cette classe ne contient que deux \emph{relations de localisation,}
\onto[orl]{Prox\-imal} et
\onto[orl]{Si\-tué\-Sur\Iti\-né\-rai\-re\-Ou\-Ré\-seau\-Sup\-port}.

Enfin, la classe
\onto[orl]{Re\-la\-tion\-Spa\-ti\-ale\-Po\-si\-ti\-on\-Re\-la\-ti\-ve},
similaire à la classe
\onto[gum]{Re\-la\-ti\-ve\-Spa\-ti\-al\-Mo\-da\-li\-ty},
%
C'est cette classe qui regroupe le plus de \emph{relations de
  localisation.} On y retrouve, par exemple, les relations traduisant
un contact\footnote{Correspondant à la classe
...
\onto[orl]{So\-us\-Pro\-che\-De}, \onto[orl]{Au\-Des\-sus\-De}).

regroupe les relations qui ont à voir avec la notion de proximité
spatiale (distance)

regroupe les relations qui dénotent que la cible et le site ont un
lien non seulement spatial, mais aussi fonctionnel. 

regroupe les relations décrivant une position relative de la cible par
rapport au site en se basant sur autre chose qu’une distance.

        
\tdi{Hiérarchie croisée}
Nous n'avons pas cherché à définir une hiérarchie \enquote{plate},
c'est-à-dire sans héritages multiples
...
L'ontologie des \emph{relations de localisation} défini donc 62
...
\emph{etc.}) et 78 relations \emph{SubClassOf,} indiquant que la
classe \enquote{fille} spécifie la classe \enquote{mère}. 

\tdi{Pas de propriétés}
...
l'ontologie GUM-Space.
%
Plus spécifiquement deux types de liens sont
