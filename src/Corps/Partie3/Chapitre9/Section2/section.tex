...
et l'extrait \nex{gv:1} nous permettent de conclure que le requérant
...
localisation retranscrivant cette description, comme
\onto[orl]{Sous\-Altitude}. Nous avons cependant défini plusieurs
relations de localisation dérivées de cette dernière, comme
\onto[orl]{Sous\-Proche\-De}, permettant une spatialisation plus
