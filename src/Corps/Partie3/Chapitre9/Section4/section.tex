...
plusieurs bibliothèques \footnote{Par exemple la fonction
  \texttt{r.sunmask} implémentée dans le \ac{sig} Grass ou la fonction
  \texttt{ta_lighting} du \ac{sig} Saga.} permettant de modéliser les
ombres produites par le relief en fonction de l'heure de la journée .
