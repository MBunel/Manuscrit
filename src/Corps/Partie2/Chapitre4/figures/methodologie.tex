\begin{tikzpicture}
  ...
  \begin{scope}
    ...
    left, cardinalite] {1} node[pos=1, fill=white] (t_dec_1) {\tiny
      \emph{Décomposition}} -| (is-g) 
    node[pos=1,below right,cardinalite]{1..*};
    
    \node[anchor=west,baseline, fill=white,inner sep=0] at ([xshift=1ex]t_dec_1.south west)
    ...
    left, cardinalite] {1} node[pos=1, fill=white] (t_dec_2) {\tiny
      \emph{Décomposition}} -| (is_o-g) 
    node[pos=1,below right,cardinalite]{1..*};
    
    \node[anchor=west,baseline, fill=white,inner sep=0] at ([xshift=1ex]t_dec_2.south west)
    ...
    left, cardinalite] {1} node[pos=1, fill=white] (t_dec_3) {\tiny
      \emph{Décomposition}} -| (is_o_r-g) 
    node[pos=1,below right,cardinalite]{1..*};
    
    \node[anchor=west,baseline, fill=white,inner sep=0] at ([xshift=1ex]t_dec_3.south west)
    ...
    node[pos=1,above right,cardinalite]{1};
        ...
        \node[anchor=west,baseline, fill=white,inner sep=0] at ([xshift=1ex]t_fus_1.south west)
    ...
    node[pos=1,above right,cardinalite]{1};
          ...
          \node[anchor=west,baseline, fill=white,inner sep=0] at ([xshift=1ex]t_fus_2.south west)
    ...
    node[pos=1,above right,cardinalite]{1};
          ...
          \node[anchor=west,baseline, fill=white,inner sep=0] at ([xshift=1ex]t_fus_3.south west)
    {\tiny des \emph{indices de localisation}};
