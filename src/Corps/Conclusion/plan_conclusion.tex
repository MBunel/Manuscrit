...
Dans la seconde partie (\ref{par:02}) de ce manuscrit, nous avons
...
Enfin, la dernière partie de cette thèse était consacrée à
l’application de notre méthode a des cas réels. À partir
