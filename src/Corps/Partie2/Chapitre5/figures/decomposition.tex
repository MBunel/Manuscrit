\begin{tikzpicture}
  ...
  % 
  \node[anchor=south,above=1.5cm of dec] (rl) {$Rl$};
  % 
  ...
  {$Rla_1$};
  % 
  \node[anchor=west,align=justify, text width=2.5cm, font=\tiny] at
  ([xshift=4ex]rla.east) {\emph{Relations de localisation atomiques}
