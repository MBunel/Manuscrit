...
positifs. Ces compromis sont cependant inacceptables.
%
Par exemple, avec la \emph{t-norme} de \bsc{Łukasiewicz} une
intersection de 10 fois la valeur 0,9 donnera un degré d’appartenance
nul, là où il serait de 0,34 avec une \emph{t-norme} probabiliste et
de 0,9 avec la \emph{t-norme} de \textcite{Zadeh1965}.
% Conclusion
