...
dans la phrase : \enquote{C'est à trois minutes de marche}.

Ces différents types de distance peuvent toutes se retrouver dans les
...
la manière la plus attendue d'exprimer une relation de distance.


On pourrait augurer que l'expression de distances métriques sous forme
quantitative est la manière la plus sure de les spatialiser. 
...
Par exemple, le phénomène \emph{d'attraction des nombres ronds}
\autocite{Durand1961}, étudié en démographie, illustre que les
estimations numériques tendent à surreprésenter les nombres se
terminant par 0 ou 5,

Par conséquent, on peut s'attendre à ce que les distances exprimées à
\enquote{vue de nez} soient impactées par ce phénomène et toute autre
forme d'arrondi.
