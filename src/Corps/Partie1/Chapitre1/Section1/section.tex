\tdi{Voir si citer Vandpoul et la ofondation petzl sur les risques en montagne}
...
en Autriche. \bsc{Devies} prône une centralisation de l'organisation
...
Les propositions de \bsc{Devies} aboutissent, en 1947, lorsque est
...
\footnote{\bsc{Bonatti} ne fera cependant pas partie des deux
...
\tdi{Ajouter un paragraphe sur la difficile mise en place des secours
  professionels dans la région de Chamonix et notamment la concurence
  ehm/guide/GSHM.}
