...
%
La \emph{rasterisation} est la première partie de la \emph{spatialisation.} Elle consiste à transformer les \emph{objets de référence} vectoriels en des rasters nécessaires à notre méthode.
%
L'étape de \emph{rasterisation} ne répond cependant pas uniquement à des contraintes techniques puisqu'elle 
