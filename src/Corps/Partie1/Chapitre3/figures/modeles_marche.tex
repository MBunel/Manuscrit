...
\begin{tikzpicture}
  \begin{axis}[
    ...
    % Langumir 1984
    \addplot[restrict x to domain={-60:-12},  thick, Q0-12] {langmuir1(5)};
    \addplot[restrict x to domain={-12:-5},  thick, Q0-12] {langmuir2(5)};
    \addplot[restrict x to domain={-5:0},  thick, Q0-12] {5};
    \addplot[restrict x to domain={0:60},  thick, Q0-12] {naismith(5,0.6)};

    % Langmuir 2013
    \addplot[restrict x to domain={-60:-12},  thick, Q1-12] {langmuir1(4)};  
    \addplot[restrict x to domain={-12:-5},  thick, Q1-12] {langmuir2(4)};
    \addplot[restrict x to domain={-5:0},  thick, Q1-12] {4};
    \addplot[restrict x to domain={0:60},  thick,  Q1-12]
    {naismith(4,0.45)};
    ...
    % Tobler
    \addplot[thick, Q2-12] {tobler(1)}; % Normal
    \addplot[thick, Q3-12] {tobler(0.6)}; % Sur sentier

    % Rees
    \addplot[ thick, Q4-12] {rees};

    % Irmischer
    \addplot[thick, Q5-12] {irmischer_1}; % Normal
    \addplot[thick, Q6-12] {irmischer_2}; % Sur sentier
