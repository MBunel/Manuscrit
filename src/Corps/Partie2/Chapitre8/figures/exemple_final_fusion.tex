\begin{tikzpicture}
  ...
  \begin{scope}
    ...
    \path[draw, ->] (acc-1) -- (acc-3w) node[pos=.25, text,
    below, text width=3cm, font=\tiny, anchor=west]{Fusion des relations de
      localisation atomiques};
    
    \path[draw, ->] (acc-2) -- (acc-4w) node[pos=.25, text, below,
    text width=2.5cm, font=\tiny, anchor=west]{Fusion des relations de
      localisation atomiques};
    
    \path[draw, ->] (acc-22) -- (acc-42w) node[pos=.25, text, below,
    text width=2.5cm, font=\tiny, anchor=west]{Fusion des relations de
      localisation atomiques};

    \path[draw, ->] (acc-5) -- (acc-62w) node[pos=.25, text, below,
    text width=2.5cm, font=\tiny, anchor=west]{Fusion des objets de
      référence non nommés};
    
    \path[draw, ->] (acc-4) -- (acc-6w) node[pos=.25, text, below,
    text width=2.5cm, font=\tiny, anchor=west]{Fusion des objets de
      référence non nommés};

    \path[draw, ->] (acc-6) -- (acc-7w) node[pos=.25, text, below,
    text width=2.5cm, font=\tiny, anchor=west]{Fusion des indices de
      localisation};
