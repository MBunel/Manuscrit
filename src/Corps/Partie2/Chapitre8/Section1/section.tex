...
archimédienne, comme une \enquote{meilleure} position, qu'un position
...
est cependant incompatible avec notre cas d'application. L'étape de
\emph{décomposition des objets de référence indéfinis}
(\autoref{fig:methodo_1}) a pour fonction de 
