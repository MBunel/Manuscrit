...
Les deux premiers extraits de l'alerte décrivent le contexte de la
descente :
%
\begin{dialogue}
  % 
...
\Req \nex{4-1} Je suis entre le \emph{Grand Veymont,} \nex{4-2} sous le
\emph{Grand Veymont} et \emph{Pas de la Ville,} tout à fait, \nex{4-3}
coté sud.
\end{dialogue}
%
Les extraits \nex{3-1} et \nex{4-1} indiquent que le requérant se
...
%
Dans l'extrait \nex{4-2} le requérant indique que sa position est
...
contexte et de l'extrait \nex{1-1} que le requérant se réfère ici au
...
%
Dans l'extrait \nex{4-3} le requérant complète cette information en
...
les extraits \nex{4-3} et \nex{6-1} est due à une erreur du requérant,
...
\enquote{entre} (\nex{7-2}) et \enquote{au-delà} (\nex{7-1}) sont
utilisées comme synonymes.
%
Pourtant, en confirmant qu'il est \enquote{au-delà} du \emph{Pas de la
  Ville} (\nex{8-1}) le requérant contredit sa précédente affirmation
(\nex{4-1}), comme quoi il serait situé entre le \emph{Pas de la
...
\nex{4-1}, l'indice que nous avons précédemment déduit de cet extrait
...
\begin{dialogue}
  ...
  % 
  \Req \nex{12-1} À 800 mètres, je crois, à vol d'oiseau.
\end{dialogue}
%
