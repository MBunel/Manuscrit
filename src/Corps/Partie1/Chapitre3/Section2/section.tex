...
\begin{quotation}
  \enquote{On commençait par suivre un sentier \textelp{}. Peu à peu,
...
l’exactitude chez \textcite{Russell,1923}, que l’on retrouve chez
...
\autocite{Bouchon-Meunier2007}, fait office de standard. La définition
de nouveaux opérateurs d'intersection et d'union nécessite de
généraliser les équation \ref{eq:norm_zadeh} et \ref{eq:conorm_zadeh},
à l'aide des concepts de \emph{norme \emph{et de} conorme
  triangulaire.}
...
\begin{table}
  ...
  \caption{Comparaison du degré d'appartenance résultant de
    l'intersection de deux ensembles, en fonction de la \emph{t-norme}
    utilisée. Avec \(a = 0,8\) et \(b = 0,5\).}
