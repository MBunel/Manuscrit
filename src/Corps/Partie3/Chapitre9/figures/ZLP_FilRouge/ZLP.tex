\subfloat[\label{fig:zlp_fil_rouge_main}]{
  \begin{tikzpicture}[remember picture,inner sep=0pt,outer sep=0pt]
    ...
    \begin{scope}[x=(img.south east),y=(img.north west)]
      \node[draw,RdBu-9-1,thick,minimum height=.9cm,minimum width=.9cm] (B1) at (0.45,0.865) {};
      \node[draw,RdBu-9-1,thick,minimum height=.9cm,minimum width=.9cm] (B2) at (0.555,0.446) {};
      \node[draw,RdBu-9-1,thick,minimum height=.9cm,minimum width=.9cm] (B3) at (0.685,0.41) {};
    \end{scope}
  \end{tikzpicture}
}
