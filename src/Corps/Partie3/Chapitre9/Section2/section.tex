...
\ref{fig:ZLC_GrandVeymont_3}, \ref{fig:ZLC_GrandVeymont_4},
\ref{fig:ZLC_GrandVeymont_5}, \ref{fig:ZLC_GrandVeymont_8} et
\ref{fig:ZLC_GrandVeymont_9}) nous pouvons construite la \ac{zlp} de
l'alerte, correspondant à l'intersection de ces 6 \ac{zlc}
(\autoref{fig:methodo_1}). La \autoref{fig:ZLP_GrandVeymont}
représente le résultat de cette intersection. Comme on peut le
remarquer, la \ac{zlp} obtenue est fragmentée. On trouve un premier
cluster de positions au centre de la \ac{zir} et un second plus à
l'ouest, dans une zone dépourvue de couvert forestier.


La \ac{zlp} de cette première alerte traitée 
