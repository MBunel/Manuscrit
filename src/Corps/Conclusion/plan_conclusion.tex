...
spatialiser les relations de localisation atomiques nous avons chacun
des concepts de cette ontologie a un ensemble de concepts décrivant
des méthodes qui seront appliquées lors de la spatialisation.
...
Une seconde piste d'amélioration que nous déjà explorée est la
