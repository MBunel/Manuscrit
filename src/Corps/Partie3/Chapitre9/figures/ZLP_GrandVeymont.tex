\begin{tikzpicture}
  ...
  (0,0){\includegraphics{./figures/ZLP_GrandVeymont.png}};
  % 
  \begin{scope}
...
([xshift=1ex]rect.east) {Limite de la \ac{zir}};
    %
\node (pnt) [circle, anchor=north west, minimum size=.15cm, inner
sep=0pt, fill=RdBu-9-1] at ([xshift=4cm, yshift=-.35cm]P1) {};
    %
    \node[anchor=west, font=\tiny\vphantom{Ag}, text width = 4cm] at
    ([xshift=1ex]pnt.east) {Position effective de la victime};
    %
