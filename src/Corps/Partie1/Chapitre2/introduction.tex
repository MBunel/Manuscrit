...
\tdi{En réfléchissant au sujet je me suis rendu compte qu'a aucun
  moment je ne donnai un ordre de grandeur dans la
  localisation. Est-ce que l'on veut qqch de très précis, pour
  identifier la position de la victime à échelle locale, \eg sous la
  forêt, ou qqch de plus large, \eg dans ce coin du
  département. Ajouter cette précision dans ce chapitre}
