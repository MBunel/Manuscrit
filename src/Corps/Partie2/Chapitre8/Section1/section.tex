...
Les \emph{t-normes} et les \emph{t-conormes} d'un même couple
d'opérateurs peuvent être archimédiennes (ou archimédiennes strictes
et non archimédiennes) indépendamment, cependant les quatre couples
duaux présentés ici
...
strictement inférieur à la valeur de \(x\). Cela implique que
l'intersection avec une telle \emph{t-norme,} de deux \ac{zlc} 
