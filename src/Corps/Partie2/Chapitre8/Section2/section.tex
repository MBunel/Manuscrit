...
de cet événement. Ces deux mesures ne peuvent cependant pas prendre
toutes les valeurs possibles. Tout d'abord la \emph{nécessité} ne peut
...
La nécessité ne peut pas être plus imporante que la possibilité

La dualité entre les mesures de possibilité et de nécessité à
plusieurs conséquences. Tout d'abord, 
