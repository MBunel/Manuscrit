...
Ces premiers problèmes \footnote{Impossibilité d'identifier les
  positions correspondant à certaines description, difficulté à
  considérer l'ensemble des cas possibles lorsque le requérant se
  réfère par rapport à un objet sans le nommer, difficulté à prendre
  en compte l'imprécision et difficulté de traiter des hypothèses en
  parallèle.} peuvent êtres
