...
décomposable. Prenons pour exemple les deux \emph{relations de
  localisation atomiques} \onto[orla]{Interieur} et
\onto[orla]{Exterieur} \footnote{Ces deux \emph{relations de
...
\onto[orla]{Exterieur}, pour cet \emph{objet de référence.} Comme nous
...
\onto[orla]{Distance\-Quantitive} et
...
La seconde partie de la \emph{spatialisation} est le calcul de la
