\begin{tikzpicture}
  \begin{scope}
    ...
    \node[text width=3cm, align=center, anchor=center] at (1,-.75) {\footnotesize \itshape Zone initiale de recherche};
  \end{scope}
  \path[draw, ->] (2.5,1.25) --++ (3,1.75)  node[pos=.5, above, sloped] {\footnotesize \itshape spatialisation};
  \path[draw, ->] (2.5,.75) --++ (3,-1.75)  node[pos=.5, above, sloped] {\footnotesize \itshape spatialisation};
  ...
  \begin{scope}[xshift=6cm,yshift=2cm]
    ...
    {\footnotesize \itshape Zone de localisation compatible};
  \end{scope}
  \path[draw, -] (8.5,3) --++ (1.5,-2);
  \path[draw, -] (8.5,-1) --++ (1.5,2);
  ...
  \begin{scope}[xshift=12cm]
    ...
    {};
        \node[text width=3cm, align=center, anchor=center] at (1,-.75)
    {\footnotesize \itshape Zone de localisation probable};
  \end{scope}
\end{tikzpicture}