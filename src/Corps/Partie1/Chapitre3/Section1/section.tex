...
La définition de classes de relations de localisation nécessite de
...
également des organisations \enquote{hybrides}, utilisant plusieurs
...
localisation, par exemple en distinguant les \emph{relations
  topologiques} (\ie invariantes par déformation) et les relations
métriques, nécessitant des mesures de distance ou d'angles.
