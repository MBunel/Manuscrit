...
ou blessées. Pour ce faire nous avons travaillé à l'identification des
\emph{différentes relations de localisation} utilisées dans le
contexte du secours en montagne pour décrire une position et nos avons
identifié leur sémantique. Pour permettre une spatialisation la plus
efficace possible, avons également du travailler à la prise en compte
de l'imprécision des relations de localisation et à l'incertitude des
