...
nodes={anchor=base, baseline}] (I) at (0,0) {I\\};

  \matrix [matrix of math nodes,
  anchor=south west,
  nodes={anchor=base, baseline,minimum size=1cm}] (is) at
  ([xshift=1cm,yshift=2cm]I.north east)
  {i_1&i_2&\cdots{}&i_n\\};

  \matrix [matrix of math nodes,
  anchor=south west, nodes={baseline,minimum size=1cm}] (is_o) at
  ([xshift=1cm,yshift=2cm]is-1-1.north east) {o_1&o_2&\cdots{}&o_n\\};

  \matrix [matrix of math nodes,
  anchor=south west,
  nodes={minimum size=1cm}] (is_o_r) at
  ...
  ([xshift=1cm,yshift=-2cm]zla-1-1.south)
  {
    \draw[ffa,ffc] (0,0) circle (.3cm);&
    \draw[ffa,ffc] (0,0) circle (.3cm);&
    \node{$\cdots{}$};&
