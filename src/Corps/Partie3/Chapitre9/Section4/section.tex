...
tout contrainte par la relation de localisation \onto[orla]{Proximal}
...
\onto[orla]{Sup\-Val} permet de considérer qu'un objet est visible à
...
mais couplée au modifieur \onto[orla]{Not}. Ainsi, si le premier
...
Une fois que les \ac{zlc} ont été calculées pour tous les objets de
