...
distance entre \texttt{X} et \texttt{Y}.


\begin{figure}
  \centering
  \subfloat[\label{fig:Metrique_FilRouge_1_obj_1}]{%
    \includegraphics{../figures/EnDirectionDe_metrique_1_FilRouge.png}}\hfill
  %
  \subfloat[\label{fig:ZLC_FilRouge_1_obj_1}]{%
    \includegraphics{../figures/EnDirectionDe_metrique_1_FilRouge.png}}
  \caption{Métrique \subref{fig:Metrique_FilRouge_1_obj_1} et \ac{zlc}
    \subref{fig:ZLC_FilRouge_1_obj_1} de la relation de localisation
