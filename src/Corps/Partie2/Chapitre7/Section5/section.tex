...
\onto[orla]{Distance}. Cependant cette distance ne peut être calculée
à partir de \emph{l'objet de référence} dans son ensemble puisque ces
...
d'appartenance soit maximal à la frontière ---~lorsque la distance est
nulle~--- et qu'il diminue avec l'éloignement, ce qui correspond au
\emph{fuzzyficateur} \onto[orla]{Eq\-Val\-0}. Pour la \emph{relation}
\onto[orla]{Not\-A\-La\-Fron\-ti\-ere\-De}, c'est le comportement
opposé qui est attendu. On peut donc utiliser le même
