...
\enquote{la signification c'est l'usage}. Il semble alors essentiel
d'étudier les descriptions de positions dans le contexte du secours en
montagne afin de construire une ontologie la plus pertinente possible.
