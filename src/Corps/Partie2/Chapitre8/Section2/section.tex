...
nécessaire d'attribuer une mesure de nécessité à toutes les parties de
\(X\).
%
XXX
%
Il est par ailleurs possible de calculer la possibilité de chaque
partie de \(X\) en ne connaissant que la partie de chaque événement de
\(X\) (ici la possibilité que le colis arrive chaque jour de la
semaine, pris indépendamment des autres).
