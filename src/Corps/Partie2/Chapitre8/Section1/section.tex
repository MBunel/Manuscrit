...
intrinsèque de rejet d'un couple d'opérateurs. Ces deux principes ont
certes une place centrale en logique
\autocite{horn2020}.


\begin{displayquote}[{\cite{Lukasiewicz1910}.}]
  Une personne faussement inculpée de meurtre ne trouverait aucun
  moyen de démontrer son innocence devant un tribunal. Tout au plus
...
Si cet exemple est assez éloquent, il perd de sa superbe si on le
transpose à notre cas d’application. Sans le principe de
\emph{non-contradiction} l'appartenance d'une position à une
\emph{zone de localisation} n'implique pas nécessairement sa
non-appartenance à l'opposée de cette zone.
