...
\SI{625}{\kilo\meter\squared} de la \ac{zir}, \num{1976} objets de
type \enquote{chemins} ou \enquote{sentiers} qui sont autant d'objets
de référence potentiels. Un indice de localisation est alors construit
...
représente la fonction d'appartenance ainsi construite.
...
chaque instance (Soit \num{3952} \ac{zlc} dans le cas présent) commence la
