...
Au terme de cette phase d'identification des indices de localisation
on a donc un ensemble de 8 indices de localisation.
%
\begin{enumerate}
\item Le requérant est \onto[orl]{Hors\-De\-Planimetrique} du sommet
  du \emph{Grand Veymont}
\item Le requérant est \onto[orl]{Sous\-Altitude} du sommet
  du \emph{Grand Veymont}
\item Le requérant est \onto[orl]{Au\-Nord\-De\-Externe} du Pas de la
  Ville
\item Le requérant est \onto[orl]{XX} du Pas de la
  Ville, par rapport au sommet du Grand Veymont
\item Le requérent est \onto[orl]{EntreXetY} le Pas de la ville est
  Pierre Blanche
