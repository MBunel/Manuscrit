...
\ac{zlc} issues de la \emph{spatialisation} des \emph{indices de
  localisation} décomposés, créés lors de la \emph{décomposition} des
\emph{objets de référence indéfinis} (Chapitres \ref{chap:04} et
\ref{chap:05}). 
...
Si leurs propriétés diffèrent, ces quatres couples partagent la
