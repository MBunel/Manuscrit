\begin{tikzpicture}[scale=.7]
  ...
  \begin{scope}[transparency group]
    % fond
    \begin{scope}
      \path[ffa] (0,2) -- (2.5,2) -- (7.5, 0)  -- (8,0) -- (0,0) -- cycle;
    \end{scope}
    % bords
    \begin{scope}
      \path[ffc] (0,2) -- (2.5,2) -- (7.5, 0) -- (8,0) ;
  ...
  \begin{scope}
    ...
    \begin{scope}
      ...
      % label
      \node[below left, yshift=-.5cm, font=\small] at (x axis) {$Distance\ (m)$};
    \end{scope}
    % Axe Y
    \begin{scope}
      % Axe
  ...
  \begin{scope}
    ...
    % Seuil 2
    \draw[ffc,line width=.7.5] (7.5,\decalageY) -- (7.5,0);
    \draw[fill, RdBu-9-1] (7.5,\decalageY) circle (2pt);
    \draw[fill, RdBu-9-1] (7.5,0) circle (2pt);
  \end{scope}
\end{tikzpicture}
