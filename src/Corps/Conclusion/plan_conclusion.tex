...
(\autoref{chap:01}). Nous avons également présenté de projet de
recherche CHOUCAS, les propositions qu'il porte pour aider les
\emph{unités de secours en montagne} dans leur tâche de localisation
et nous avons défini la problématique de notre thèse et le contexte
scientifique dans lequel elle s'inscrit, le \emph{Geographic
  Information Retrieval} (\autoref{chap:02}). Enfin, nous avons dressé
un état de l'art sur les questions au centre de notre travail de
recherche, la modélisation de l'imprécision et des relations de
...
indices (\autoref{chap:07}) en des zones de localisation flous
...
Nous avons donc proposé une méthode s'appuyant sur le cadre théorique
