...
\begin{table}
  ...
  \begin{tabular}{clcc}
    ...
    \addlinespace
    \multirow{2}{*}{\ref{ind:fr3}}&\onto[orla]{Inf\-Val}&50&\SI{100}{\meter}\\
                   &\onto[orla]{Inf\-Val\-0}&\emph{0}&\SI{5}{\meter}\\
    \addlinespace
    \multirow{2}{*}{\ref{ind:fr4}}&\onto[orla]{Inf\-Val\-0}&\emph{0}&\SI{10}{\meter}\\
    ...
    \addlinespace
    \multirow{2}{*}{\ref{ind:fr6}}&\onto[orla]{Inf\-Val\-0}&\emph{0}&\SI{6}{\meter}\\
                   &\onto[orla]{Inf\-Val\-0}&\emph{0}&\SI{10}{\meter}\\
    \addlinespace
    \ref{ind:fr7}&\onto[orla]{Eq\-Angle}&\emph{0}&\SI{18}{\degree}\\
    \bottomrule
  \end{tabular}
...
Les secouristes du \ac{pghm} de Grenoble nous ont signalé que, dans
