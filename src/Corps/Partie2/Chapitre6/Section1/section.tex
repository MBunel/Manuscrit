...
modélisée. Une \emph{relation} comme \onto[orl]{Près\-De} voit, toute
chose égale par ailleurs, son \textsl{degré de validité} diminuer
linéairement avec l'éloignement à \emph{l'objet de référence.}
