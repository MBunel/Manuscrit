...
\onto[orla]{Interieur} et \onto[orla]{Exterieur}, pour cet \emph{objet
...
0 dans la cas contraire \footnote{Nous aurions pu utiliser une des
  ...
  les utiliser pour illustrer cet exemple.}  calculée en chaque pixel
de la \ac{zir} (\autoref{fig:Exemple_Metrique_vs_Selecteur}). On
obtient alors un raster contenant (explicitement) une information
permettant de distinguer les pixels situés à l'intérieur et à
l'extérieur de \emph{l'objet de référence.} On peut alors construire :
% 
\begin{itemize}
