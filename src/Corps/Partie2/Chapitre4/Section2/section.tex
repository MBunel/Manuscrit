...
une \emph{zone de localisation probable} correspondant à \emph{une
  description de position.} Ce découpage n'est cependant pertinent
qu'en première approche, la \emph{fusion} et (surtout) la
\emph{spatialisation} étant elles-mêmes des opérations complexes et
décomposables.
%
