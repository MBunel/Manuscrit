...
dériviés, comme \onto[orla]{Eq\-Val\-0}, \onto[orla]{Inf\-Val\-0) ou
  des fonctions d'appartenance obtenues par l’application d'un
  modifieur à une fonction normalisée.
...
pas sûrs (\ie la nécessité est nulle). Si la \emph{possibilité} que le
...
éléments de l'ensemble de référence, alors aucun de ses éléments ne
