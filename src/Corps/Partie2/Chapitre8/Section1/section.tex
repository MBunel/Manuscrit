...
homogène, où l'ensemble des pixels possèdent le même degré
d'appartenance, qu'il soit égal à 1 (\autoref{fig:tiers-exclu}) ou nul
...
(\autoref{fig:non-contradiction}).

de 1, correspondant à \emph{l'ensemble de référence} \(X\)
(\autoref{eq:def_ensemble_flou}), alors que
s à 1, ils ne valident
