...
pour une aire de \SI{625}{\kilo\meter\squared} \footnote{Compte-tenu
  ...
  figures au 1/250000 (\eg \autoref{}) sont composées de pixels de
  \SI{250}{\meter} de côté et les figures aux 1/600000 (\eg
  \autoref{}) de pixels de \SI{600}{\meter} de côté). La réduction de
  la résolution des rasters a pu créer certains artéfacts visuels (\eg
  déformations de zones).}  (\autoref{fig:zir_fil_rouge}).
