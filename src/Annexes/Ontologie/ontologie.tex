...
\dict{\onto{AEstDeExterne}}{La \emph{cible} est disjointe et se situe
  globalement à l’est du \emph{site.}}{}%
...
\dict{\onto{A\-La\-Frontiere\-De}}{Le \emph{site} a une emprise
  ...
  (\onto{Dans\-Pla\-ni\-mé\-tri\-que}) ou à l'extérieur du
  \emph{site.} Si elle est à l’intérieur, elle est alors dans le
  complémentaire de la zone de l’espace qui vérifie la relation
  \onto{Au\-Milieu\-De}. La distance à considérer dépend très
  probablement de la nature ou de la taille du
  \emph{site.}}{\enquote{Je suis un peu à la sortie de la forêt.}}%
...
\dict{\onto{ApresJalonSurItineraire}}{La \emph{cible} est située sur
  ...
  \onto{Situe\-Sur\-Itineraire\-Ou\-Reseau\-Support}), et après le
...
\dict{\onto{AuDessusJalonSurItineraire}}{La \emph{cible} est au-dessus
  ...
  \onto{Situe\-Sur\-Itineraire\-Ou\-Reseau\-Support}).}{\enquote{\textelp{}
