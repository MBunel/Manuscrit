...
\begin{dialogue}
  % 
  \Req \nex{1} J'ai eu du mal à descendre entre le sommet du grand
  veymont et là où je suis. \nex{2} La descente était très très lente.
\end{dialogue}
%
...
l'extrait \nex{1} ne décrit pas la position actuelle du requérant,
...
\begin{dialogue}
  % 
  \Sec \nex{3} Vous êtes entre \emph{Grand Veymont} et \emph{Pas de
la Ville} ?

\Req \nex{4} Je suis entre le \emph{Grand Veymont,} \nex{5} sous le
\emph{Grand Veymont} et \emph{Pas de la Ville,} tout à fait, \nex{6}
coté sud.
\end{dialogue}
% 
Les extraits \nex{3} et \nex{4} indiquent que le requérant se situe
entre le sommet du \emph{Grand Veymont} et le \emph{Pas de la Ville,}
ce que l'on peut modéliser avec la \emph{relation de localisation}
\onto[orl]{Entre\-X\-et\-Y}.
%
Dans l'extrait \nex{5} le requérant indique que sa position est située
en dessous du \emph{Grand Veymont.} Bien que ce ne soit pas
explicitement mentionné dans l'extrait on comprend à l'aide du
contexte et de l'extrait \nex{1} que le requérant se réfère ici au
...
contraire, des extraits comme le \nex{1} ou le \nex{5} laissent
...
%
Dans l'extrait \nex{6} le requérant complète cette information en
...
\begin{dialogue}
  %
  \Sec \nex{7} Côté Sud du \emph{Pas de la Ville} ?
%
  \Req \nex{8} Non, côté Nord.
\end{dialogue}
%
En précisant le site dans sa question (\nex{7}) le secouriste nous
...
les extraits \nex{6} et \nex{8} est due à une erreur du requérant, ou
à une utilisation implicite du second site (le \emph{Grand
...
\begin{dialogue}
  % 
  \Sec \nex{9} Vous êtes au-delà du \emph{Pas de la Ville ?} \nex{10}
  Entre \emph{Pas de la ville} et \emph{Pierre Blanche ?}
  % 
  \Req \nex{11} Oui, je suis au-delà du \emph{Pas de la Ville.}
\end{dialogue}
%
Les questions posées par le secouriste dans les extraits \nex{9} et
\nex{10}
%
On ne peut, en effet, pas considérer que les prépositions
\enquote{entre} (\nex{10}) et \enquote{au-delà} (\nex{9}) sont
utilisées comme synonymes.
%
Pourtant, en confirmant qu'il est \enquote{au-delà} du \emph{Pas de la
  Ville} (\nex{11}) le requérant contredit sa précédente affirmation
(\nex{4}), comme quoi il serait situé entre le \emph{Pas de la Ville}
et le \emph{Grand Veymont.}
...
\nex{4}, l'indice que nous avons précédemment déduit de cet extrait
...
\begin{dialogue}
  %
  \Req \nex{12} Sur une zone à peu près plate et
  caillouteuse. \nex{13} Sur une petite prairie.
\end{dialogue}
%
...
\nex{15}, portant sur l'éloignement de la position du requérant au
\emph{Pas de la ville :}
%
\begin{dialogue}
  \Sec \nex{14} Vous êtes à combien du Pas de la ville ?
  % 
  \Req \nex{15} À 800 mètres, je crois, à vol d'oiseau.
\end{dialogue}
%
