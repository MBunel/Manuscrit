...
\dict{\onto{Dans\-Planimetrique}}{La \emph{cible} est située dans
  ...
  (cf. \onto{ALaFrontiereDe}, qui est compatible avec
  \onto{HorsDePlanimetrique}, avec \onto{DansPlanimetrique}, ou avec
  une situation ou ni l'un ni l'autre ne s'applique).}{\enquote{Non,
    on est en forêt.}}%
...
\dict{\onto{PresDe}}{La \emph{cible} est \enquote{proche} du
  ...
  \onto{DansPlanimetrique} implique \ono{PresDe} mais l'inverse n'est
