...
soit par la durée de leurs alertes ---~qui varie de quelques secondes
à plusieurs dizaines de minutes (\autoref{fig:dist_temps_alertes})~---
ou par leur contenu. Malheureusement nous n'avons que peu
d'informations sur le contexte de ces différentes alertes. Si nous
savons que ces dernières ne sont qu'une sélection parmi l'ensemble des
