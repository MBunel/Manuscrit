...
spatialisant les différents indices de localisation en une seule zone,
...
\bsc{Łukasiewicz,} une intersection de 10 fois la valeur 0,9 donnera
...
utilisés dans la littérature nous a conduit à rejeter la plupart
...
que l'archimédianité (a fortiori stricte) des opérateurs n'était pas
