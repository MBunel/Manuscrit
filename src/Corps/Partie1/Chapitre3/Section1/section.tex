...
% Langmuir 
Dans sa formulation originale, ce modèle ne propose pas d'estimation
de la vitesse de marche en descente. \textcite{Langmuir1984} propose
d'étendre ce modèle en :
%
\begin{enumerate*}[label=(\alph*)]
...
\textcite{Langmuir2013} proposera une version corrigée de sa
précédente proposition pour l'adapter à l'estimation de la vitesse de
marche d'un groupe. Cette seconde itération propose de réduire la
vitesse de marche à \SI{4}{\kilo\meter\per\hour} et d'ajouter une
heure de marche par tranche de \SI{450}{meter} de dénivelé
positif. La version corrigée du modèle de \autocite{Naismith1892} par
\textcite{Langmuir1984, Langmuir2013} peut s'exprimer de la manière
suivante :
...
Avec \(V_{h1}\) la vitesse ascensionnelle pour les montées
(\SI{600}{\meter\per\hour} dans \textcite{Langmuir1984} et
\SI{450}{\meter\per\hour} dans \textcite{Langmuir2013}), \(V_{h2}\)
ascensionnelle pour les descentes de plus de 5 degrés
(\SI{1,8}{\kilo\meter\per\hour}). Comme on peut le voir sur la figure
\ref{fig:modeles_marche} ce modèle, surtout dans sa formulation
originale \autocite{Langmuir1984}, a un comportement assez particulier
pour les faibles pentes, la vitesse estimée par le modèle pouvant
atteindre \SI{12}{\kilo\meter\per\hour}, une vitesse de marche très
élevée, même dans des conditions optimales.
