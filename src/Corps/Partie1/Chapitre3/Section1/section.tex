...
correspondant, par exemple, à l'intersection d'une anse (\(a\)) et
d'un panier (\(b\)).
...
Cependant, la description de ce qui est
visible d'une position donnée permet, sinon de l'identifier
précisément, d'en faciliter la localisation.
