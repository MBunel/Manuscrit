...
La construction de la \emph{zone de localisation probable}
correspondant à \emph{l'indice de localisation} pris pour exemple
nécessite de \emph{fusionner} les deux \emph{zones de localisations
  compatibles} correspondant aux \emph{relations de localisation
  atomiques}
\onto[orla]{Al\-ti\-tu\-de\-Stric\-te\-ment\-Inf\-érieu\-re} et
\onto[orla]{Dis\-tan\-ce\-Quan\-ti\-ta\-ti\-ve\-Pla\-ni\-mé\-tri\-que}
à l'aide d'une intersection. Si son appliquation est dépendante de
l'implémentation, la méthode utilisée est fixée par le modèle
théorique. La \emph{théorie des sous-ensembles flous} nécessite
d'employer une \emph{t-norme.} Pour cette comparaison nous avons
choisi d'utiliser les opérateurs de \textcite{Zadeh1965} où la
fonction \emph{minimum} fait office de \emph{t-norme.}
