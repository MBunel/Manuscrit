...
s'ajoute la décompostion des relations de localisaiton atomiques, qui
subdivise chacun de ces 2XXX nouveaux indices de localisaiton en deux
nouveaux indices, le premier correspondant à la relation de
localisaiton \onto[orla]{Sous\-Altitude} et le second à la relation de
localisation \onto[orla]{Proximal}.


La relation de localisaiton \onto[orl]{Sous\-Proche\-De} 


Comme pour l'exemple présenté dans le \autoref{chap:06}, la métrique utilisée
