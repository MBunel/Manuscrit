...
Dans les extraits \ref{gv:9} et \ref{gv:10}, le secouriste demande au
requérant s'il est situé \enquote{au-delà} du \emph{Pas de la Ville}
et \enquote{entre} le \emph{Pas de la Ville} et \emph{Pierre Blanche.}
La formulation employée par le secouriste laisse penser que ces deux
informations se complètent et se précisent.

La question posée par le secouriste dans l'extrait \ref{gv:10} :
\enquote{\textins{Vous êtes} entre le \emph{Pas de la Ville} et
  \emph{Pierre Blanche ?}} n'est, quant à elle, ni affirmée, ni
infirmée par le secouriste.
...
\onto[orl]{Sous\-Jalon\-Sur\-Itineraire}, 
