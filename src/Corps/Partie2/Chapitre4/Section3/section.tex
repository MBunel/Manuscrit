...
\begin{figure}
  ...
  \caption{Illustration des étapes de \emph{fusion des objets de
      référence indéfinis} \protect\subref{fig:ex_fus_obj} et de
    fusion des \emph{indices de localisation}
    \protect\subref{fig:ex_fus_inf}}
\end{figure}
