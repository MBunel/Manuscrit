...
gauche et à droite dans le sens de la ligne électrique) permettent de
délimiter une distance planimétrique à \emph{l'objet de référence} et
donc de représenter la \emph{relation de localisation atomique}
\onto[orla]{Dis\-tan\-ce\-Quan\-ti\-ta\-ti\-ve\-Pla\-ni\-mé\-tri\-que}. Si
...
correspondent à l'éloignement maximal pour une
\emph{alpha-cut} donnée.
