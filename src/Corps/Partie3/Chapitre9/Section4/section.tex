...
correspond à la durée d'une longue randonnée.

ce qui indique que toute position atteignable en
moins de 6 heures de marche à partir de \emph{Bourg-d'Oisans}
appartiendra totalement à la \ac{zlc} de ce premier sous-indice
. Le second paramètre, \(\delta\), a
également été fixé à 6 heures. Ainsi, le degré d'appartenance
commencera à décroitre à partir de 6 heures de marche et deviendra nul
à 12 heures. La fonction d'appartenance ainsi définie décroit donc
assez lentement, ce qui permet la 
