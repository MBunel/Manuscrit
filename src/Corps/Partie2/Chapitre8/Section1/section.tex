...
les applications successives des \emph{t-normes} (\emph{t-conormes})
des trois autres couples d'opérateurs ont pour effet de faire diminuer
(ou augmenter) le degré d'appartenance. Ainsi, pour les opérateurs de
...
assez éloignées des considérations principales de ce
travail. Cependant, en modifiant le comportement des \emph{t-normes}
et des \emph{t-conormes} ces propriétés influent le résultat des
intersections et des unions, c'est-à-dire le cœur de la \emph{phase de
  fusion.} Il est donc nécessaire d'en étudier attentivement les
conséquences.
%
...
\begin{figure}
  \centering
  \subfloat[]{\input{../figures/fnc_app_inc.tex}}\hfill
  \subfloat[]{\input{../figures/fnc_app_inc_2.tex}}

  \subfloat[]{\input{../figures/fnc_app_inc_3.tex}}\hfill
  \subfloat[]{\input{../figures/fnc_app_inc_4.tex}}
  \caption{sq}
  \label{fig:qs}
\end{figure}
