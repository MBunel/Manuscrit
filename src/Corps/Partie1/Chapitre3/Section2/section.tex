...
La \emph{t-norme} de \textcite{Zadeh1965} est, de toutes les
\emph{t-normes} présentées, la moins stricte
\autocite{Bouchon-Meunier2007}. À l'inverse, la \emph{t-conorme} de
\bsc{Zadeh} est la plus stricte des \emph{t-conormes} présentées.
