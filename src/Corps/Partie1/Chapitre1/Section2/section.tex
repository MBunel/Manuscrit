...
d'interpréter une description telle que : \enquote{la victime est sous
  une route et entend des véhicules}, 

En
effet, une même description peut être utilisée dans des contextes
différents ou pour décrire des positions qui le sont tout autant, 

Il
est donc nécessaire de prendre cet aspect en considération et
d'adapter la méthodologie pour qu'elle puisse prendre en compte
l'imprécision.
