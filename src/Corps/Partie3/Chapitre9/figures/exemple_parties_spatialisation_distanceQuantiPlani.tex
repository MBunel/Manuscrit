\begin{tikzpicture} 
  \node[anchor=east] (x1) at (-3.5,0) {\onto[orla]{Au\-Nord\-De}};

  \node[anchor=west] (y1) at (3.5,.8) {\onto[orla]{Centroide}};
  \node[anchor=west] (y2) at (3.5,0) {\onto[orla]{Ecart\-Angulaire}};
  \node[anchor=west] (y3) at (3.5,-0.8) {\onto[orla]{Eq\-Val\-Angle}};
