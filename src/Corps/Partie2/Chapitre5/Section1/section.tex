...
fichiers, compilés et montés par le \ac{pghm} de Grenobles,
constituent deux corpus d'alertes distincts, dont le premier (20
alertes) nous a été transmis en 2017 et le second (32 alertes) en
2019. Ces deux corpus ne présentent pas de différences fondamentales
dans leur contenu, bien que le corpus de 2019 contienne des alertes en
moyenne plus courtes et toutes les alertes enregistrées par le
\ac{pghm} de Chamonix.
