...
\onto[orala]{} et \onto[orala]{} ou \onto[orala]{} et \onto[orala]{}),
mais il s'agit de cas particuliers et il est, par exemple, impossible
de définir une \emph{zone de localisation compatible} à partir de ce
qui n'est pas vu, ou qui n'est pas à la même altitude \footnote{Il
  n'existe pas de \emph{relations}
  \onto[orla]{Site\-Ne\-Voit\-Pas\-Cible} ou
  \onto[orla]{Pas\-A\-La\-Meme\-Altitude\-Que}.}. Pourtant
...
% Ordre modifieurs
La possibilité de cumuler les \emph{modifieurs} pose le problème de
