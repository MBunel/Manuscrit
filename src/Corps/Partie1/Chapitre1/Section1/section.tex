...
\bsc{Thomas} \autocite{Thomas1911} met en évidence le fait que, sous
...
L'action de ces deux nouveaux corps est régulée au niveau local par
...
de 1986 relative à l'aide médicale d'urgence \footnote{L’ordonnance n°
  2000-548 du 15 juin 2000 abroge les articles 1 et 2 de la loi \no
  86--11 et crée les articles L6311-1 et L6311-2 du code de la santé
  public de contenu identique.}  \autocite{Rocourt2014} qui précise
que le rôle de l'aide médicale d'urgence est
\enquote{\textins{d'}assurer aux malades \textelp{} en quelque endroit
...
% Cadre Légal
Comme nous l'expliquions précédement (\ref{par:1-1-1-1-2}),
l'organisation des secours en montagne est régulée par les plans
\ac{orsec}. Leur élaboration et leur application est inputée, par la
legislation nationale, aux préfets de département. Ces derniers sont
...
désigné par le préfet \enquote{à partir d’une liste annuelle de cadres
  ...
  circulaire \bsc{Khil} (cf. \autoref{circ:khil}).}. Dans les faits,
...
(\ref{par:1-1-1-1-2}), ont la liberté de déleguer les secours à des
...
qui n'exclu pas des interventions dans les \emph{domaines skiables} en
...
précédement (\ref{par:1-1-1-1-2}), cette organisation a été appliquée
...
ont des organisations particulières. Dans les Alpes-de-haute-Provence,
par exemple, le secours en montagne est à la charge seule du \ac{pghm}
de Jausiers. Enfin, pour des raisons historiques, le département de la
Haute-Savoie est organisé suivant un régime unique. Dans la majorité
du département les secours sont réalisés par une équipe mixte,
toujours composée de secouristes du \ac{pghm} et de pompiers du
\ac{gmsp}. Mais les secours dans le massif du mont Blanc, où les
secours sont à la charge seule du \ac{pghm}, acteur historique des
secours dans le département \autocite{Halle2007,Boillot2017}.
...
comme les Hautes--Alpes et les Alpes--de--Haute--Provence (appareils
des \ac{fag}), d'autres à deux, comme l'Isère (deux appareils du
\ac{ghsc}), la Savoie et la Haute-Savoie (avec un appareil des
\ac{fag} et un du \ac{ghsc} par département). Dans les cas où les
secouristes peuvent pas réaliser un secours faute d'hélicoptère
(appareil déjà utilisé ou en panne), il leur est possible de demander
une assistance à un département voisin. En Isère, par exemple, le plan
\ac{orsec} préconise de faire cette demande si le délais d'attente
pour disposer d'un hélicoptère est supérieur à 30 minutes.
...
s'effectuer sous la coordination du \emph{centre opérationel de zone}
...
des pompiers, des militaires du régiment grenoblois d'infantrie
...
randonées dans l'Oisans et les Écrins. La mise en place de ces deux
permanences de haute-saison est néanmoins contrainte à une
diponibilité suffisante des moyens humains et matériels, si ceux-ci ne
...
sa position sont identifiées. Or, si toute invertention nécessite de
...
circulaire \bsc{Kihl} en impose même la vérification systématique.
...
\enquote{compétance exclusive} des \ac{usem} pour les opérations de
...
consiste à identifier manuellement la postion du requérant à partir
...
Le principal avantage de cette méthode est qu'elle est totatelment
transparente pour la victime. Aucune action de sa part n'est
nécessaire pour le localiser. Cependant cette méhode n'est pas pas
...
Il existe cependant certaines situations où, malgrès les outils de
...
préocupant, le secouriste en fonction l'estime incapable d'utiliser
...
La particularité de cette alerte est que toutes les inforamtions
...
départ sont imprécies, \enquote{quelques heures}, \enquote{plusieurs
  métres}, etc. Par conséquent, plusieurs endroits dans la région de
Bourg-d'Oisans correspondent à cette description. Les secouristes
complétent donc leurs informations avec une réquisition auprès de
l'opérateur de téléphonie mobile, ce qui leur apporte une nouvelle
information, le téléphone de la victime est connecté à une antenne
\enquote{GSM SFR située à la chapelle st-Philomene à Villard-Reymond
  (38520) et orientée au 90°} \autocite{Lot 0.4}. Cette nouvelle
