...
pour chacun d'entre eux. Les figures \label{fig:metrique_dist_foret_1}
et \label{fig:metrique_dist_foret_2} représentent le résultat du
calcul de la métrique \onto[orla]{Distance} pour deux instances de
forêts.
