...
\begin{figure}
  \centering
  \subfloat[\label{fig:intersection_incert_1}]{\input{../figures/comparaison_intersection_incertitude.tex}}

  \subfloat[\label{fig:intersection_incert_2}]{\input{../figures/comparaison_intersection_incertitude_2.tex}}
  \caption{Résultat de l'intersection de deux \ac{zlc} avec la
    \emph{t-norme} de \bsc{Zadeh} avec
    \subref{fig:intersection_incert_1} et sans
    \subref{fig:intersection_incert_2} incertitude.}
...
% \begin{figure}
%   \centering
%   \subfloat[]{\input{../figures/comparaison_union_incertitude.tex}}

%   \subfloat[]{\input{../figures/comparaison_union_incertitude_2.tex}}
