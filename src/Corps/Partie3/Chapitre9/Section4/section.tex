...
compatible avec un déplacement de quelques dizaines de minutes.

Toutefois
le cas que nous modélisons ici est un peu différent, puisque la durée
donnée, \enquote{plusieurs heures}, est très approximée.
%
