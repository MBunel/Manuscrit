\subfloat[\label{fig:zlp_fil_rouge_main}]{
  \begin{tikzpicture}[remember picture,inner sep=0pt,outer sep=0pt]
    ...
    \begin{scope}[x=(img.south east),y=(img.north west)]
      \draw[draw] (0,0) grid (1,1);
      \node[draw,RdBu-9-1,thick,minimum height=1cm,minimum width=1cm] (B1) at (0.45,0.87) {};
      \node[draw,RdBu-9-1,thick,minimum height=1cm,minimum width=1cm] (B2) at (0.56,0.44) {};
      \node[draw,RdBu-9-1,thick,minimum height=1cm,minimum width=1cm] (B3) at (0.69,0.4) {};
    \end{scope}
  \end{tikzpicture}
}
