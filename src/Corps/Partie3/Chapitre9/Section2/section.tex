...
intersection. Comme on peut le remarquer, la \ac{zlp} obtenue est
fragmentée. On trouve un premier cluster de positions au centre de la
\ac{zir} et un second plus à l'ouest. C'est dans le premier cluster
que l'on trouve les positions dont le degré d'appartenance à la
\ac{zlp} est le plus élevé. Le second cluster n'est constitué que de
positions dont le degré d'appartenance est assez faible. Comme on peut
le voir sur les précédentes \ac{zlc}, la valeur de 
