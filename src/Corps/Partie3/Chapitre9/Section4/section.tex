...
\begin{figure}
  ...
  \caption{Métrique \protect\subref{fig:SousAlt_Metrique_1} et
    ...
    localisation \protect\onto[orla]{Sous\-Proche\-De} appliquée à une
    instance de chemin.}
  \label{fig:SousAlt_1}
\end{figure}
...
\begin{figure}
  ...
  \subfloat[\label{fig:SousAlt_fnc}]{%
    \includegraphics{../figures/FNC_ALTINF_Chemin_FilRouge.tex}}\hspace{1cm}
  % 
  \subfloat[\label{fig:Proximal_fnc}]{%
    \includegraphics{../figures/FNC_DIST_Chemin_FilRouge.tex}}
  % 
  \caption{}
