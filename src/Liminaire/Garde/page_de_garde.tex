...
\begin{titlepage}
  ...
  \begin{minipage}{0.6\textwidth}
    \centering
    % Pour l'obtention
    {\usekomafont{subtitle} Thèse\par} \vspace{.01\textheight}
    {\usekomafont{titlehead} Présentée pour l'obtention du grade
      de \par
  ...
  \begin{minipage}[t]{0.95\textwidth}
    ...
    \vspace{.01\textheight} {\footnotesize
      \begin{tabular}{m{0.95\textwidth}}
        ...
        \dotfill Rapportrice\\
        M\up{me} Sophie \bsc{de Rufferay}, Professeur, Université XX, Rouen \dotfill Rapportrice\\
        M. Thomas \bsc{Devogele}, Professeur, Université François
        Rabelais, Tours  \dotfill
        Examinateur\\
