...
\begin{tikzpicture}
  \begin{axis}[
    ...
    % Tobler
    \addplot[thick, RdBu-9-9] {tobler(1)}; % Normal
    \addplot[thick, dashed, RdBu-9-9] {tobler(0.6)}; % Sur sentier

    % Rees
    \addplot[thick, RdBu-9-1] {rees};

    % Irmischer
    \addplot[thick, RdBu-9-3] {irmischer_1}; % Normal
    \addplot[ultra thick, RdBu-9-3] {irmischer_2}; % Sur sentier
