...
Comme nous l'expliquions dans le
\autoref{chap:07}, le rasteriser \onto[orla]{Part\-Visible} calcule la
part de l'objet de référence visible pour chaque position de la
\ac{zir}. Dans le cas de cet indice de localisation, la
...
le troisième indice de localisation. Ces paramètres sont, certes,
larges mais ils nous permette
...
spatialisation de ce cinquième indice de localisation.
...
La \autoref{fig:ZLC_FilRouge_7} représente le résultat de la
