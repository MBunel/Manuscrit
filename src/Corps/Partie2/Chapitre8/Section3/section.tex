...
de \si{0,6}) au second. Pour le second \emph{indice de localisation}
...
manière a construire la \ac{zlc} spatialisant la \emph{relation de
  localisation} \onto[orl]{Au\-Sud\-De\-Ex\-ter\-ne} pour
...
(\onto[orla]{Proche\-De}), il n'est donc pas nécessaire d'intersecter
ces deux zones.
