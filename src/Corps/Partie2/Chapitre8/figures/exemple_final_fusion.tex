\begin{tikzpicture}
  ...
  \begin{scope}
    ...
    \draw (zlc6.north west) -| ($(zlc6.north west)!0.5!(zlc62.south
    west) + (-.1,0)$) |- (zlc62.south west) node[pos=0, yshift=.2] (acc-4w)
    {};
    \draw (zlc5.north east) -| ($(zlc5.north east)!0.5!(zlc62.south
    east) + (.1,0)$) |- (zlc62.south east) node[pos=0, yshift=.2] (acc-4)
    {};

    \draw (zlc7.north west) -| ($(zlc7.north west)!0.5!(zlc8.south
    west) + (-.1,0)$) |- (zlc8.south west) node[pos=0, yshift=.2] (acc-5w)
    {};
    \draw (zlc7.north east) -| ($(zlc7.north east)!0.5!(zlc8.south
    east) + (.1,0)$) |- (zlc8.south east) node[pos=0, yshift=.2] (acc-5)
    {};

    \path[draw, -, shorten >=5pt, shorten <=5pt] (acc-1) -- (acc-3w);
