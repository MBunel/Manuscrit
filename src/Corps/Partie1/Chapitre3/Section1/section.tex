...
\item une \emph{relation de localisation} \autocite{XXXXXX},
\end{enumerate*}
%
qui, combinés, permettent d'exprimer un \emph{référencement indirect}
\autocite{XXXXX}. Ainsi, on peut trouver ces trois éléments dans des
phrases aussi variées que :
\textquote[{\cite[79]{Borillo1998}}]{l'extérieur de la boîte est
  laqué}, \textquote[{\cite[101]{Vandeloise1986}}]{la chaumière est
  au-dessus de la tour} ou \enquote{le chalet est à une heure de
