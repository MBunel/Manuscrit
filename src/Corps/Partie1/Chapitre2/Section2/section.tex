...
Comme nous l'avons expliqué lors de la présentation des objectifs
précédents (\ref{subsec:2-1-2} et \ref{subsec:2-1-3}), nous souhaitons
que la prise en compte de \emph{l'imprécision des relations de
  localisation} et de \emph{l'incertitude} des \emph{indices de
  localisation} soit intrinsèque à la méthode de \emph{spatialisation}
des \emph{indices de localisation} (\ref{subsec:2-1-1}). Il est par
conséquent nécessaire que la méthode de \emph{fusion} des indices
