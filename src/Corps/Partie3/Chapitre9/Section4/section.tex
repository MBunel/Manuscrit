...
Le second indice de localisation \footnote{La victime est
  \onto[orl]{A\-Temps\-De\-Marche\-De} Bourg-d’Oisans
  (\ref{ind:fr2}).} donne une estimation du temps pendant lequel la
victime. Pour ce faire nous proposons d’employer la relation de
localisation \onto[orl]{A\-Temps\-De\-Marche\-De}. Il s'agit une
