...
et \onto[orla]{Proximal}, utilisées pour la décomposition de
\onto[orl]{Sous\-Pro\-che\-De,} et par conséquent à l'intersection de
ces deux \ac{zlc}.
%
...
identifier toutes les positions validant la relation de localisation
spatialisée pour au moins un \emph{objet de référence.}
%
