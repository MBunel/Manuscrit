...
La constitution d'une telle base pose cependant plusieurs
problèmes. Tout d'abord il faut en définir la structure, tout en
s'assurant qu'elle permette de formaliser toutes les variations de
décompositions souhaitées.
%
De plus, il est nécessaire qu'elle
contienne l'ensemble des 
%
d'identifier
