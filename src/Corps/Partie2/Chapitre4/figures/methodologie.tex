\begin{tikzpicture}
  ...
  \begin{scope}[shift={($(lvl1.north) +(0,2cm)$)}, local bounding box=lvl2]
    ...
    anchor=south east,
    nodes={anchor=base, baseline,minimum size=1cm}] (is) at (-5cm,0) {i_1&i_2&\cdots{}&i_n\\};
  ...
  \begin{scope}
    ...
    {1} node[pos=0.5, fill=white, center] {\tiny Bijection} node[pos=1,below,cardinalite]{1}; 
