...
Les \ac{usem} ont la possibilité de localiser la victime en
...
cette méthode. En effet, cette solution n'est pas très précise, les
antennes GSM étant assez espacées en dehors des milieux urbains. De
plus l'antenne de rattachement d'un téléphone mobile n'est pas
systématiquement celle qui en est la plus proche, divers facteurs,
comme la météo ou l'utilisation du réseau, pouvant modifier l'antenne
de rattachement. À la faible précision de cette méthode s'ajoute sa
lenteur. Pour des raisons légales les secouristes ne peuvent obtenir
cette information des opérateurs qu'avec une réquisition judiciaire.

peuvent localiser indirectement le téléphone qui les
...
. Cependant cette méthode n'est pas pas
très précise. En effet 
% 
