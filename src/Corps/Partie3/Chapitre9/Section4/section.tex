...
l'indice de localisation : \enquote{Le requérant est
...
\begin{figure}
  ...
  \caption{\ac{zlc} de la relation de localisation
...
localisation (\ref{ind:fr3}). Par conséquent, nous ne reviendrons pas
