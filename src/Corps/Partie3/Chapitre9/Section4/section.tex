...
plusieurs bibliothèques \footnote{Par exemple la fonction
  \texttt{r.sunmask} implémentée dans le \ac{sig} Grass
  \autocite{GDT2020} ou la fonction \texttt{ta_lighting} du \ac{sig}
  Saga \autocite{Conrad2015}.} permettant de modéliser les ombres
produites par le relief en fonction de l'heure de la journée.
