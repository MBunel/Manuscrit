...
\enquote{d'alerte} pour désigner, à la fois la phase de localisation
d'une opération de secours donnée, mais également l'ensemble des
éléments décrivant une position donnés par le requérant lors de cette
phase de localisation. Dans son acceptation formelle, telle que
définie dans \emph{l’ontologie d'alerte Choucas}
...
opération de secours donnée. Une alerte est donc caractérisée par
l'ensemble des \emph{indices de localisation} qui s'y rattachent, mais
également par sa temporalité et l'identité de la \emph{victime} et du
...
pour une même alerte, à définir plusieurs \footnote{À l'exception du
  ...
  rencontre pas en pratique.} \emph{zones de localisation,} une pour
chaque \emph{indice de localisation,} auxquelles s'ajoute une dernière
zone, construite par la \emph{fusion} des résultats de la
