...
que pour la \emph{relation} XXX de la \emph{relation de localisation
  atomique} \protect\onto[orla]{Dans\-Pla\-ni\-mé\-tri\-que}, la
distance planaire, représentée par la classe
\onto[orla]{XXXX}. Cependant cette distance ne peut être calculée à
...
d'employer le \emph{rasteriser} \onto[orla]{Frontiere}, déjà
...
\onto[orla]{A\-La\-Fron\-ti\-ere\-De} on souhaite que le degré
...
au \emph{fuzzyficateur} \onto[orla]{Eq\-Val\-0}. Pour la
...
\begin{figure}
  ...
  \caption{Exemple de la XXX des \emph{relations de localisation
      atomiques} \protect\onto[orla]{A\-La\-Fron\-ti\-ere\-De} et
