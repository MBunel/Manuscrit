...
sources de données qui possèdent des lacs modélisés sous forme de
polygone. Selon la requête, la réponse peut être unique ou multiple
\autocite{Halilali2018}.
