  ...
  \begin{minipage}[t]{0.95\textwidth}
    ...
    \vspace{.01\textheight} {\footnotesize
      \begin{tabular}{m{0.95\textwidth}}
        ...
        \dotfill Rapportrice\\
        M\up{me} Sophie \bsc{de Rufferay}, Chercheuse (HDR), IGN \dotfill Rapportrice\\
        M. Thomas \bsc{Devogelle}, Professeur, Université de Franche-comté \dotfill
        Examinateur\\
        M. Didier \bsc{Josselin}, Professeur, Université Paris 1
        \dotfill Examinateur\\
        M. Olivier \bsc{Favre}, Professeur, Université Paris 1 \dotfill Invité\\
