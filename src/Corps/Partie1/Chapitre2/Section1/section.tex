...
ce n'est jamais le cas en pratique, les secouristes disposent toujours
de plusieurs \emph{indices de localisation,} même si l'un d'entre eux
est extrêmement précis, comme des coordonnées GPS.
