...
\begin{figure}
  \centering
  \subfloat[\label{fig:fuzzy_veyont_angleNord_1}]{\input{./figures/fuzzy_veymont_distance.tex}}\hspace{1cm}
  \subfloat[\label{fig:fuzzy_veyont_angleNord_2}]{\input{./figures/fuzzy_veymont_angleNord.tex}}
